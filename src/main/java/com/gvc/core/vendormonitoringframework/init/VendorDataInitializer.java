...
public class VendorDataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Vendor vendor2 = new Vendor("Zendesk", 10, "https://vendorzendesk.com", true,"3","CS Tech","12","18","fas fa-whale");
        Vendor vendor3 = new Vendor("Jenkins", 15, "https://www.jenkins.io/", true,"6","CS Jenkins Stack","16","24","fab fa-jenkins");
        Vendor vendor4 = new Vendor("BitBucket", 15, "https://bitbucket.org/product", true,"5","CS Bucket","24","29","far fa-kiwi-bird");
        Vendor vendor5 = new Vendor("Medallia", 15, "https://www.medallia.com/", true,"4","CSM Tech","29","34","bx bxl-reddit");
        Vendor vendor6 = new Vendor("Siteminder", 15, "https://www.siteminder.com/", true,"8","SITEMINDER","34","49","fas fa-union");
        Vendor vendor7 = new Vendor("Certainly", 15, "https://certainly.io/", true,"12","Casier","29","32","fas fa-window-alt");
