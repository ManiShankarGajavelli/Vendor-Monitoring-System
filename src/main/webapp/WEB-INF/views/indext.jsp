...
.list-message .list-group-item.active:hover, .list-message .list-group-item.active:focus,
...
<body>
	...
	<header class="d-flex justify-content-between align-items-center p-3">
		<div>
			<img src="${pageContext.request.contextPath}/VMS.PNG"
				alt="Vendor Monitoring Service Logo" width="100">
		</div>
		<div>
	...
	<div class="d-flex">
		...
		<nav class="col-md-2">
			<ul class="nav flex-column">
				...
				<li class="nav-item"><a class="nav-link active" href="#Vendors"><i
						class="fas fa-users"></i> Vendors</a></li>
				<li class="nav-item"><a class="nav-link" href="#Tickets"><i
				...
				<div class="container mt-5 mb-3">
					<div class="row">
						<div class="col-md-4">
							...
							<div class="card card-grow p-3 mb-2">
								<div class="d-flex justify-content-between">
									<div class="d-flex flex-row align-items-center">
										...
										<div class="ms-2 c-details">
											<h6 class="mb-0">
												Jira<a href="#" class="copy-url" data-vendor="Vendor 1">
													<i class="far fa-copy"></i>
												</a>
											</h6>
											<span> <i class="fas fa-circle"
												style="color: #ff0000;"></i>1 days ago
											</span>
										</div>
									</div>
									<div class="badge">
								...
								<div class="mt-5">
									...
									<div class="mt-5">
										...
										<a
											class="card-block stretched-link text-decoration-none view-more"
											data-toggle="modal" data-target="#vendorModal" href="#">
											<div class="mt-3">
												<span class="text1">32 Pending <span class="text2">of
														50 Total</span></span>
											</div>
										</a>
									</div>
							...
							<div class="card p-3 mb-2">
								...
								<div class="mt-5">
									...
									<div class="mt-5">
										...
										<div class="mt-3">
											<span class="text1">42 Pending <span class="text2">of
													70 Total</span></span>
										</div>
									</div>
								</div>
							...
							<div class="card p-3 mb-2">
								...
								<div class="mt-5">
									...
									<div class="mt-5">
										...
										<div class="mt-3">
											<span class="text1">52 Pending <span class="text2">of
													100 Total</span></span>
										</div>
									</div>
								</div>
				...
				<div class="container mt-4">
					...
					<div class="mb-3">
						<div class="form-inline">
							<label class="mr-2">Filter:</label> <select id="filterPriority"
	...
	<div class="modal fade" id="vendorModal" tabindex="-1" role="dialog"
		aria-labelledby="vendorModalLabel" data-backdrop="static"
		aria-hidden="true">
				...
				<div class="modal-header">
					<ul class="nav nav-tabs">
						<li class="nav-item"><a class="nav-link active"
							id="tickets-tab" data-toggle="tab" href="#tickets">Tickets</a></li>
						<li class="nav-item"><a class="nav-link"
							id="documentation-tab" data-toggle="tab" href="#documentation">Documentation</a>
						</li>
						<li class="nav-item"><a class="nav-link" id="faqs-tab"
							data-toggle="tab" href="#faqs">FAQs</a></li>
					</ul>
				</div>
											...
											<div class="panel-body no-padding">
												<div class="list-group no-margin list-message">
													<a href="#" class="list-group-item">
														...
														</p> <span class="badge badge-success float-right rounded">SOLVED</span>
														...
														<p class="list-group-item-text">
															Ticket #15: <strong>JIRA Reports has invalid
																Data :(</strong>
														</p> <span class="badge badge-success float-right circle">SOLVED</span>
													</a>
												</div>
												<!-- /.list-group -->
											</div>
    ...
    <div class="panel">
        <div class="panel-heading">
            <a href="mail-compose.html" class="btn btn-danger float-right rounded"><i class="fas fa-share-alt"></i></a>
            <div class="media">
                <a class="mr-3" href="#">
                    <img src="https://bootdey.com/img/Content/avatar/avatar1.png" alt="Rebecca Cabean" class="img-circle avatar">
                </a>
                <div class="media-body">
                    <h4 class="media-heading">Rebecca@atlasian.com <small>(Jira response)</small></h4>
        ...
        <div class="panel-body">
            <p class="lead">
                <br> RE : We have an expected outage and we will inform once it was fixed.
            </p>
            <hr>
            <p>
                Thanks! <br> Rebecca.
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <p class="lead">
                Hi<br> Jira URL for Entain are not working in some area, please check this on priority.
            </p>
            <hr>
            <p>
                Thanks! <br> Siva.
	...
	<div class="modal fade" id="ticketDetailsModal" tabindex="-1"
		role="dialog" aria-labelledby="ticketDetailsModalLabel"
		aria-hidden="true">
	...
	<!-- Create Ticket Modal -->
	<div class="modal fade" id="createTicketModal" data-backdrop="static"
		tabindex="-1" role="dialog" aria-labelledby="createTicketModalLabel"
		aria-hidden="true">
